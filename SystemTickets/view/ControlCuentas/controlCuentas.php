                                            ...
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control form-control-sm" id="floatingNombreCliente" placeholder="Nombre Cliente" >
                                                        <label for="floatingNombreCliente">Nombre Cliente</label>
                                                    </div>
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control form-control-sml" id="floatingApellidoCliente" placeholder="Apellido Cliente">
                                                        <label for="floatingApellidoCliente">Apellido Cliente</label>
                                                    </div>
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control" id="floatingDNIEmpleado" placeholder="DNI Empleado">
                                                        <label for="floatingDNIEmpleado">DNI Empleado</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3">
                                                    ...
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control" id="floatingCorreo" placeholder="Correo Electrónico">
                                                        <label for="floatingCorreo">Correo Electrónico</label>
                                                    </div>
                                                    <div class="form-floating mb-3">
                                                        <input type="password" class="form-control" id="floatingContrasena" placeholder="Contraseña">
                                                        <label for="floatingContrasena">Contraseña</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="text-center">
                                                <button type="button" class="btn btn-success m-1">Crear Cuenta</button>
                                            </div>
                                        </div>                   
                                    </div>
                                </div>
